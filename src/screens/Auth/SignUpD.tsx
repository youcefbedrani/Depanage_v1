...
import Phone_Registre from "../../components/Phone_Registre";
import Email_Registre from "../../components/Email_Registre";
    ...
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{flexGrow : 1}}>
      <View className="flex-1 items-start justify-start w-full h-screen bg-white pt-14 mt-14">
        ...
        <View className="mx-14 mt-4 flex-row space-x-2">
          ...
          <TouchableOpacity onPress={() => navigation.navigate("Home_L")}>
